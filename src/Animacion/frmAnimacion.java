...
public class frmAnimacion extends javax.swing.JFrame {
    ...
    public frmAnimacion() {
        ...
        try {
            foregroundTin = ImageIO.read(getClass().getResource("/imagenes/tinaco4.png"));
            backgroundTin = ImageIO.read(getClass().getResource("/imagenes/tinacoColor.png"));
            foregroundTer = ImageIO.read(getClass().getResource("/imagenes/termometro3.png"));
            backgroundTer = ImageIO.read(getClass().getResource("/imagenes/terColor.png"));
            foregroundLam = ImageIO.read(getClass().getResource("/imagenes/lampara.png"));
            backgroundLam = ImageIO.read(getClass().getResource("/imagenes/lamparaColor.png"));
